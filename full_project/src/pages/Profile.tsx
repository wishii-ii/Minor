    ...
    return (
      <div className="p-6 max-w-7xl mx-auto">
        <div className="text-center py-12">
          <h2 className="text-2xl font-bold text-gray-600 dark:text-gray-300">Please sign in to view your profile</h2>
          <p className="text-gray-500 dark:text-gray-400 mt-2">Your profile will appear here once you're signed in.</p>
        </div>
      </div>
    );
  }
        ...
        <div className="flex items-center gap-4 mb-4">
          {user.avatar && user.avatar.match(/\.(jpeg|jpg|gif|png|webp|svg)$/i) ? (
            <img
              ...
              className="w-20 h-20 rounded-full border-2 border-indigo-200 dark:border-indigo-600 object-cover"
            />
          ) : (
            <div className="w-20 h-20 rounded-full border-2 border-indigo-200 dark:border-indigo-600 bg-indigo-500 flex items-center justify-center text-white text-2xl">
              {user.avatar || user.displayName?.charAt(0) || 'U'}
            </div>
          )}
          <div>
            <h1 className="text-3xl font-bold text-gray-800 dark:text-white mb-1">{user.displayName}</h1>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="bg-white dark:bg-gray-800 p-4 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm text-center">
              ...
              <div className="text-lg font-bold text-gray-800 dark:text-white">Lv {user.level}</div>
              <div className="text-xs text-gray-500 dark:text-gray-400">Level</div>
            </div>
            <div className="bg-white dark:bg-gray-800 p-4 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm text-center">
              <FaFire className="w-8 h-8 text-red-500 mx-auto mb-2" />
              <div className="text-lg font-bold text-gray-800 dark:text-white">{user.streakCount}</div>
              <div className="text-xs text-gray-500 dark:text-gray-400">Day Streak</div>
            </div>
            <div className="bg-white dark:bg-gray-800 p-4 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm text-center">
              <FaTrophy className="w-8 h-8 text-yellow-500 mx-auto mb-2" />
              <div className="text-lg font-bold text-gray-800 dark:text-white">{earnedAchievements}</div>
            ...
            <div className="bg-white dark:bg-gray-800 p-4 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm text-center">
              ...
              <div className="text-lg font-bold text-gray-800 dark:text-white">{user.coins || 0}</div>
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm">
            <h3 className="text-xl font-bold text-gray-800 dark:text-white mb-4">Level Progress</h3>
            <div className="space-y-4">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className="font-medium text-gray-800 dark:text-white">{user.xp} / {user.xpToNext} XP</span>
              </div>
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="text-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                <div className="text-2xl font-bold text-gray-800 dark:text-white">{habits.length}</div>
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm">
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                <span className="text-sm text-gray-600 dark:text-gray-300">Display Name</span>
